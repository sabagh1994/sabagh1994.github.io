...
-->
@def title       = "Firth Bias Reduction in Few-Shot Learning"
@def prepath     = "firthfsl"
@def description = """
                   On the Importance of Firth Bias Reduction in
                   Few-Shot Classification
                   """
@def authors     = "Ehsan Saleh, Saba Ghaffari, David Forsyth, and Yu-Xiong Wang"
<!--  NAVBAR SPECS
  NOTE:
...
@def nav_logo_path  = "/assets/firthfsllogo_wl.svg"
...
@def github_repo      = "ehsansaleh/firth_bias_reduction"
...
-->
@def header_link_color  = "#ffffff"
@def header_hover_color = "#ffffff"
@def header_color       = "#10797d"
<!-- @def header_color       = "#46a0a3" -->
@def link_color         = "#2669DD"
@def link_hover_color   = "teal"
@def white_bg_color     = "#f6f8fa"
@def section_bg_color   = "#ebf2f2"
<!-- @def white_bg_color     = "#f5e4f4" -->
